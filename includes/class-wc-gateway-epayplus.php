...
class WC_Gateway_Epayplus extends WC_Payment_Gateway {
	...
	function init_form_fields() {
		...
		$this->form_fields = array(
			...
			'sourcekey' => array(
				...
				'type' => 'text',
				'description' => __( "Contact your NDMS Rep to get your Secure ID or Refer to the ePay+ Welcome email. If you dont have an ePay+ Account please visit our website <a href='http://epayplus.ndmscorp.com' target='_blank'>http://epayplus.ndmscorp.com</a> or Call 424.247.5511 for more information.", 'wc-gateway-epayplus' ),
				'default' => ''
			),
			'command' => array(
	 ...
	 * @return null
	 **/
	protected function send_debugging_email( $debug ) {
